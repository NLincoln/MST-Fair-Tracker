...
export const DislikeCompanyButton = createButton(dislikeCompany, ThumbsDownIcon, {
  prop: 'is_disliked',
  style: {
    color: 'blue'
  }
...
export const FavoriteCompanyButton = createButton(favoriteCompany, FavoriteIcon, {
  prop: 'is_favorited',
  style: {
    color: 'red'
  }
